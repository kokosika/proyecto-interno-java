...
public class InsertRiesgoDto {
	...
	private Integer nombreResponsable;
	private String identTipoUsuario;
	private Integer probabilidadRiesgo;
	private Integer vigenciaRiesgo;
	...
	public Integer getNombreResponsable() {
		return nombreResponsable;
	}
	public void setNombreResponsable(Integer nombreResponsable) {
	...
	public Integer getProbabilidadRiesgo() {
		return probabilidadRiesgo;
	}
	public void setProbabilidadRiesgo(Integer probabilidadRiesgo) {
		this.probabilidadRiesgo = probabilidadRiesgo;
	}
	public Integer getVigenciaRiesgo() {
		return vigenciaRiesgo;
	}
	public void setVigenciaRiesgo(Integer vigenciaRiesgo) {
